...
export class LoginRegisterService {
  ...
  public RegisterRequest(
    ...
    return Axios.post(this.apiUrl + `/register`, payload, headerConf).pipe(
      catchError(this.handleError),
    );
  }
  ...
  public ResetPasswordRequest(
    ...
    return Axios.put(this.apiUrl + `/reset`, payload, headerConf).pipe(
      catchError(this.handleError),
    );
  }

  public LogoutRequest(): Observable<AxiosResponse<any>> {
    return Axios.get(this.apiUrl + `/logout`, headerConf).pipe(
      catchError(this.handleError),
    );
  }
